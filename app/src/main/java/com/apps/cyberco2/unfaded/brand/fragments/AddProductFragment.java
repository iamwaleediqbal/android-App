...
import com.apps.cyberco2.unfaded.databinding.FragmentAddProductBinding;
...
public class AddProductFragment extends Fragment {
    FragmentAddProductBinding productBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        productBinding = DataBindingUtil.inflate(LayoutInflater.from(getContext()), R.layout.fragment_add_product,
            container, false);
        // Category
...
// add children in expandable layout
